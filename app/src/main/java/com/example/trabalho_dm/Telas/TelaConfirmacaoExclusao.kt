...
@Composable
fun TelaConfirmacaoExclusao(navController: NavController) {
    Box(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "Tem certeza que deseja excluir essa obra?",
                    fontSize = 20.sp,
                ...
                Button(
                    onClick = { navController.navigate(Screen.tela_Obras_adm3_1_2.route)},
